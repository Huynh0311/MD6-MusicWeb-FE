"use strict";
var Base = function () {
    var e = "active", t = $("body"), a = function (a, r) {
        var l = $("#line_loader");
        l.show().animate({width: 20 + 80 * Math.random() + "%"}, 200), $.ajax({
            ...
            "success" === t && 200 == a.status && (e = $("<div>" + e + "</div>"), $("head title").html(e.find("title").html()), $("#wrapper").html(e.find("#wrapper").html()), $("html, body").animate({scrollTop: 0}, 100), n(), i(), Dashboard.init())
        })).fail((function () {
            window.location.href = "404.html"
        })).always((function () {
            r && r.length && $(window).width() < 992 && ($(".sidebar-toggler").toggleClass(e), t.removeAttr("data-sidebar-toggle")), l.animate({width: "100%"}, 200).fadeOut(300, (function () {
                $(this).width("0")
            }))
        }))
    }, i = function () {
        var e = Utils.getLocalItem("skin"), t = document.getElementById("header"),
        ...
        if ($('[data-scroll="true"]').each((function () {
            ...
            var e = parseInt(this.getAttribute("data-swiper-slides")), t = this.parentElement,
                a = this.getAttribute("data-swiper-loop"), i = this.getAttribute("data-swiper-autoplay"),
                n = t.querySelector(".swiper-button-next"), r = t.querySelector(".swiper-button-prev"),
                ...
                s = t.querySelector(".swiper-scrollbar"), d = 1, p = 2;
            ...
            a && (u.loop = a), i && (u.autoplay = {
                ...
                pauseOnMouseEnter: !0
            }), n && r && (u.navigation = {nextEl: n, prevEl: r}), l && (u.pagination = {
                el: l,
                type: o,
                clickable: !0,
                dynamicBullets: !0
            }), s && (u.scrollbar = {el: s, draggable: !0}), new Swiper(this, u)
        })), document.querySelector(".dropzone") && (Dropzone.autoDiscover = !1, new Dropzone(".dropzone", {url: "/file/post"})), a = "mat-tabs__line", i = $("<span>", {class: a}), n = $(".mat-tabs"), r = $(".nav-link"), n.each((function () {
            var e = $(this).find(".nav-link.active").outerWidth();
            i.stop().css({width: e}), i.appendTo(this)
        })), r.on("click", (function () {
            var e = $(this);
            e.closest(".mat-tabs").find("." + a).stop().css({left: e.position().left, width: e.outerWidth()})
        })), l = !1, $(".sidebar-toggler").on("click", (function () {
            ...
            $("[data-play-id]").removeClass(e), $("[data-play-id=" + o.id + "]").addClass(e)
        }
    };
    return {
        init: function () {
            $("#loader").fadeOut(1e3), t.settings(), n(), $(window).on("popstate", (function () {
                var e = window.location.href.split("/").pop();
                e && a(e)
            })), $(document).on("click", 'a:not([href^="#"])a:not([href^="mail"])a:not([href^="tel"]):not([href^="javascript"]):not(.external):not([target])', (function (e) {
                e.preventDefault(), e.stopPropagation();
                var t = $(this).closest("#sidebar"),
                    i = "undefined" !== $(this).attr("href") ? $(this).attr("href") : null;
                ...
                if (e && e.destroy(), t) {
                    var a = {
                        ...
                        options: {
                            ...
                            elements: {borderJoinStyle: "bevel", borderCapStyle: "round", line: {tension: .4}},
                        ...
                        options: {
                            ...
                            scales: {
                                y: {
                                    min: 0,
                                    max: 80,
                                    grid: {borderColor: Utils.isDarkMode() ? "#34343e" : "#EFF2F5"}
                                }, x: {grid: {borderColor: Utils.isDarkMode() ? "#34343e" : "#EFF2F5"}}
                            },
                            layout: {margin: 0, padding: 0},
                            plugins: {legend: {display: !1}}
                        }
...
var Player = function () {
    var e = "active", t = $("body"), a = $("#playlist"), i = [], n = Amplitude.getConfig(),
        r = {playPause: !1, nextPrev: !1}, l = function (e) {
            ...
            $("#player").addClass("show"), Amplitude.getSongs() && 1 === Amplitude.getSongs().length && (Amplitude.pause(), l((() => {
                Player.volumeBackground()
            }))), Amplitude.init({
                songs: i, callbacks: {
                    song_change: function () {
                        l((() => {
                            v(), "playing" === Amplitude.getPlayerState() ? g() : $("[data-play-id]").removeClass(e), d(n)
                        }))
                    }
                }
            });
            ...
            i = [], p(), Amplitude.pause(), n.player_state = "paused", Utils.removeLocalItem("songs"), a.html('<div class="col-sm-8 col-10 mx-auto mt-5 text-center">\n            <i class="ri-music-2-line mb-3"></i>\n            <p>No songs, album or playlist are added on lineup.</p>\n        </div>'), l((() => {
                h(), v()
            }))
        }, g = function () {
            var t = Amplitude.getActiveSongMetadata();
            ...
            if ("mediaSession" in navigator) {
                ...
                a.metadata = new MediaMetadata({
                    ...
                    artist: e.artist,
                    album: e.album,
                    artwork: [{src: e.cover_art_url, sizes: "96x96", type: "image/jpg"}, {
                        src: e.cover_art_url,
                        sizes: "128x128",
                        type: "image/jpg"
                ...
                }), i.length >= 1 && !r.playPause && (r.playPause = !0, a.setActionHandler("play", (() => (Amplitude.play(), m(), void g()))), a.setActionHandler("pause", (() => (Amplitude.pause(), void h())))), i.length >= 2 && !r.nextPrev && (r.nextPrev = !0, a.setActionHandler("previoustrack", (() => Amplitude.prev(t))), a.setActionHandler("nexttrack", (() => Amplitude.next(t))))
            }
        };
    return {
        volumeBackground: function () {
            var e = $('.player-volume input[type="range"]'), t = parseInt(e.val(), 10),
            ...
            var r;
            !function () {
                if (Utils.getLocalItem("songs") && Utils.getLocalItem("songs").length && (i = Utils.getLocalItem("songs"), o(!1), h(), i.length > 1)) for (let t = 0; t < i.length; t++) {
                    var e = i[t];
                    0 === t ? a.html(u(e)) : a.append(u(e))
                }
            }(), t.on("click", "[data-play-id]", (function () {
                var t = s(this), n = i.findIndex((e => e.id === t.id));
                ...
                e.stopPropagation();
                var t = parseInt($(this).data("remove-song-id")), a = $(this).closest("[data-song-id"),
                ...
                if (i.length >= 1) {
                    for (var e = 0; e < i.length; e++) a.find(".list__item").eq(e).remove();
                    for (e = i.length - 1; e > -1; e--) {
                        var t = i[e], n = Amplitude.getActiveSongMetadata();
                        t.id !== n.id && Amplitude.removeSong(e)
                    }
                    c()
                }
            })), (r = $(".player-volume")).find('input[type="range"]').on("input", (function () {
                var e = r.find(".ri-volume-mute-fill"), t = r.find(".ri-volume-down-fill"),
                    a = r.find(".ri-volume-up-fill"), i = $(this), n = parseInt(i.val(), 10), l = "d-block",
                    o = "d-none";
                ...
                v(), l((() => {
                    "playing" === Amplitude.getPlayerState() ? g() : $("[data-play-id]").removeClass(e)
                }))
...
$(document).ready((function () {
    ...
    e.fn.extend({
        ...
        var n, r, l, o = a.body, s = "skin", d = "setting", p = "Theme Settings",
            u = ["yellow", "orange", "red", "green", "blue", "purple", "indigo", "dark"], c = ["light", "dark"],
            g = "data-theme", m = "data-header", h = "data-sidebar", v = "data-player", y = () => {
                var e = a.getElementById("header"), t = a.getElementById("sidebar"), n = a.getElementById("player"),
                    r = {dark: i.dark, header: i.header, sidebar: i.sidebar, player: i.player};
                Utils.setLocalItem(s, r), r.dark ? o.setAttribute(g, "dark") : o.removeAttribute(g), e && i.header && e.setAttribute(m, i.header), t && i.sidebar && t.setAttribute(h, i.sidebar), n && i.player && n.setAttribute(v, i.player)
            }, f = (e, t, a) => {
                ...
                var t = e(`#${d}`), a = e(`#${d}_toggler`), n = e(`.${d}__option`), r = "show", l = "active";
                e(o).on("click", (() => {
                    t.removeClass(r)
                })), a.on("click", (() => {
                    t.toggleClass(r)
                    ...
                    var t = e(this), a = t.data("theme-option"), n = t.data("header-option"), r = t.data("sidebar-option"),
                        o = t.data("player-option");
                    a ? (e("[data-theme-option]").removeClass(l), i.dark = "dark" === a, Utils.changeSkin()) : n ? (e("[data-header-option]").removeClass(l), i.header = n) : r ? (e("[data-sidebar-option]").removeClass(l), i.sidebar = r) : o && (e("[data-player-option]").removeClass(l), i.player = o), t.addClass(l), y()
                }))
            };
        (l = Utils.getLocalItem(s)) && (i = e.extend({}, i, l)), y(), n = a.createElement("div"), r = `<a href="javascript:void(0);" id="${d}_toggler">Settings</a>\n                    <div class="${d}__wrapper">\n                        <div class="${d}__head">${p}</div>\n                        <div class="${d}__body">`, r += f(c, "Theme", "theme"), r += f(u, "Header", "header"), r += f(u, "Sidebar", "sidebar"), r += f(u, "Player", "player"), r += '<p class="mt-4">Note: You can see the color change effect of the header, sidebar and player in the inner pages.</p></div></div>', n.id = d, n.innerHTML = r, o.appendChild(n), b(), i.dark ? e('[data-theme-option="dark"]').addClass("active") : e('[data-theme-option="light"]').addClass("active"), e("[data-header-option=" + i.header + "]").addClass("active"), e("[data-sidebar-option=" + i.sidebar + "]").addClass("active"), e("[data-player-option=" + i.player + "]").addClass("active")
