            ...
            l.show().animate({ width: 20 + 80 * Math.random() + "%" }, 200),
                $.ajax({ url: a, type: "GET", dataType: "html" })
                    .done(function (e, t, a) {
                        "success" === t &&
                        200 == a.status &&
                        ((e = $("<div>" + e + "</div>")), $("head title").html(e.find("title").html()), $("#wrapper").html(e.find("#wrapper").html()), $("html, body").animate({ scrollTop: 0 }, 100), n(), i(), Dashboard.init());
                    })
                    .fail(function () {
                        window.location.href = "404.html";
                    })
                    .always(function () {
                        r && r.length && $(window).width() < 992 && ($(".sidebar-toggler").toggleClass(e), t.removeAttr("data-sidebar-toggle")),
            ...
            if (
                ($('[data-scroll="true"]').each(function () {
                    ...
                    $(".swiper").each(function () {
                        ...
                        l && (u.pagination = { el: l, type: o, clickable: !0, dynamicBullets: !0 }),
                        s && (u.scrollbar = { el: s, draggable: !0 }),
                            new Swiper(this, u);
                    }),
                document.querySelector(".dropzone") && ((Dropzone.autoDiscover = !1), new Dropzone(".dropzone", { url: "/file/post" })),
                    (a = "mat-tabs__line"),
                    (i = $("<span>", { class: a })),
                    (n = $(".mat-tabs")),
                    (r = $(".nav-link")),
...
var Player = (function () {
    ...
    return {
        ...
        init: function () {
            var r;
            !(function () {
                if (Utils.getLocalItem("songs") && Utils.getLocalItem("songs").length && ((i = Utils.getLocalItem("songs")), o(!1), h(), i.length > 1))
                    ...
                    Player.volumeBackground(),
                        0 === n
                            ...
                            : n > 0 && n < 70
                                ...
                                : n > 70 && (e.addClass(o), t.addClass(o), a.removeClass(o).addClass(l));
                }),
        ...
        e.fn.extend({
            ...
            (e.settings = function (t, i) {
                    ...
                    b = () => {
                        ...
                        e(o).on("click", () => {
                            ...
                            n.on("click", function () {
                                ...
                                a
                                    ? (e("[data-theme-option]").removeClass(l), (i.dark = "dark" === a), Utils.changeSkin())
                                    : n
                                        ? (e("[data-header-option]").removeClass(l), (i.header = n))
                                        : r
                                            ? (e("[data-sidebar-option]").removeClass(l), (i.sidebar = r))
                                            : o && (e("[data-player-option]").removeClass(l), (i.player = o)),
                                    t.addClass(l),
                                    y();
                            });
                    };
                (l = Utils.getLocalItem(s)) && (i = e.extend({}, i, l)),
                    ...
                    (r += f(u, "Player", "player")),
                    (r += '<p class="mt-4">Note: You can see the color change effect of the header, sidebar and player in the inner pages.</p></div></div>'),
                    (n.id = d),
                    (n.innerHTML = r),
                    o.appendChild(n),
                    b(),
